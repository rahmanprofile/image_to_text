...
class ImageToTextDetector extends StatefulWidget {
  const ImageToTextDetector({super.key});

  @override
  State<ImageToTextDetector> createState() => _ImageToTextDetectorState();
}
        ...
        child: Column(
          children: <Widget>[
            Padding(
              ...
              child: ImageComponent(imagePath: pickedImagePath),
            ),
            ElevatedButton(
